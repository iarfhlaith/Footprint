<?php /* Smarty version 2.6.14, created on 2009-06-04 11:55:33
         compiled from teaser.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'validate', 'teaser.tpl', 91, false),)), $this); ?>
...
<div id='botContainer'>
	<div id='innerBot'>
		...
		<h4>Already registered your interest? Go straight to the <a style='color:#FF8C06;' href='http://footprintapp.com/signup/'>sign-up</a> page</h4>
		...
		<form method='post' action='/?thank_you'>
			<table>
				...
				<tr>
					...
					<td class='input'>
						<input name='firstname' id='firstname' maxlength='50' class='focused' value='<?php echo $this->_tpl_vars['firstname']; ?>
' />
						<div class='warning'><?php echo smarty_function_validate(array('id' => 'firstnameWarning','message' => 'Please enter your firstname'), $this);?>
</div>
					</td>
				</tr>
				<tr>
					...
					<td class='input'>
						<input name='lastname' id='lastname' maxlength='50' class='blurred' value='<?php echo $this->_tpl_vars['lastname']; ?>
' />
						<div class='warning'><?php echo smarty_function_validate(array('id' => 'lastnameWarning','message' => 'Please enter your lastname'), $this);?>
</div>
					</td>
				</tr>
				<tr>
					...
					<td class='input'>
						<input name='email' id='email' maxlength='50' class='blurred' value='<?php echo $this->_tpl_vars['email']; ?>
' />
						<div class='warning'><?php echo smarty_function_validate(array('id' => 'emailWarning','message' => 'Please provide a valid email address'), $this);?>
</div>
					</td>
				</tr>
				<tr>
