...
<div id='content'>
	...
	<div class='notice bad'>
		<h2>Some Information Is Missing.</h2>
		<p>
			The feature you're trying to access needs some more information to run properly. Try going back to the previous
			page and filling out the form again.
		</p>
		<ul>
			<li><a href='/app'>Go to your dashboard</a></li>
		</ul>
	</div>
