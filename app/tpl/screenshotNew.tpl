...
<head>
	<title>New Screenshot - [~$user.organisation~] - Footprint</title>
...
<div id='content'>
	...
	<h1 id='headerScreenshot'>New Screenshot</h1>
	...
	[~elseif $projects~]
		<form name='screenshotNew' id='screenshotNew' action='/app/screenshotNew.php' method='post' enctype='multipart/form-data'>
		<input type="hidden" name="MAX_FILE_SIZE" value="15728640" /> <!-- 15MB -->
		<table class='formTable'>
		<tr>
		 <td><label for='name'>Screenshot Name</label></td>
		 <td><input name='name' id='name' value='[~$name~]' /> <span class='required'>*</span></td>
		 <td><div class='formTip'>Choose a meaningful name like "Homepage Design"</div></td>
		</tr>
		<tr>
		 <td><label for='file'>Choose Image</label></td>
		 <td><input type='file' size='41' name='file'></td>
		 <td><div class='formTip'>Supported formats include jpeg, png and gif.</div></td>
		</tr>
		<tr>
		 <td colspan='2'>
		  ...
		  <td><div class='formTip'>Why not use this to detail why you designed the image the way you did?</div></td>
		</tr>
		...
		<tr>
		 ...
		 <td><div class='formTip'>Select the relevent project.</div></td>
		</tr>
		<tr id='taskRow'>
		...
		<div class='submit'>
			<input type='submit' id='submit' name='submit' value='Save Screenshot' />
	...
	[~else~]
		...
		<div class='notice pointer'>
			<h2>Wait, a project must exist before you can add a screenshot.</h2>
			<p>
				Screenshots need to be stored somewhere so they can be kept track of. So, a project
				must be created first before you can add your first screenshot.
			</p>
		...
		<div class='formPreview'>
			<img src='/app/media/images/firstView/screenshotNew.gif' alt='Preview of the New Screenshot form' id='firstViewPreview' />
		</div>
