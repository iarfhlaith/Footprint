...
$openidPath = "C:\\Documents and Settings\\Administrator\\My Documents\\Business\\Projects\\Footprint\\root\\site\\app\\inc\\plugins\\openID";

$path_extra = dirname(dirname(dirname(__FILE__)));
$path = ini_get('include_path');
$path = $path_extra . PATH_SEPARATOR . $path . PATH_SEPARATOR . $openidPath;
